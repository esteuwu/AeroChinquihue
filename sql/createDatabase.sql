-- Airplanes
CREATE TABLE airplanes (airplane TEXT, seats INTEGER);
...
-- Destinations
CREATE TABLE destinations (destination TEXT, prices TEXT, frequency INTEGER);
...
-- Payment Methods
CREATE TABLE payment_methods (payment_method TEXT);
